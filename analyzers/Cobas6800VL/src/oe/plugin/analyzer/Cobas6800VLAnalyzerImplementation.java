...
//			entry = (java.util.Map.Entry) iterator.next();
	...
	public void createVLResultFromEntry(List<String> lines, java.util.Map.Entry entry,
	...
	private String getAppropriateResults(String result) {
		...
		if (result.contains("BT") || result.contains("ND") || result.contains("<20") || result.contains("<LL")
				|| result.contains("ValueNotSet"))
			result = "< LL";
		else
			try {
